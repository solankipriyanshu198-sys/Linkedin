"""
COMPLETE FIXED CODE - jobportal/urls.py
Cleaned and Fixed URL Patterns
"""
...
urlpatterns = [
    ...
    # Company Views - FIXED: Only one URL pattern for company_profile
    path('employer-register/', views.employer_register, name='employer_register'),
    path('company/<int:pk>/', views.company_profile, name='company_profile'),  # <-- MAIN COMPANY PROFILE (WITH JOBS!)
